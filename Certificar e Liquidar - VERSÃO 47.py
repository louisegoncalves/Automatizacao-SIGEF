                    ...
                    if ja_foi_certificado == False:
                        ...
                        if documento_ja_cadastrado == True:
                            try:
                                ...
                                pagina2.append([ug,gestao,processo_formatado,nome,credor_final,valor_final,banco,agencia,conta,nota_de_empenho,despesa_certificada,ainda_nao_foi_feito,ainda_nao_foi_feito,ainda_nao_foi_feito,data,operacao,data_formatada,agora,value_numero_cortado])
                                
                                verificacao = str(pagina2.cell(row=linha,column=3).value)

                                while verificacao != processo_formatado:
                                    print("Aguarde um momento, apagando linhas em branco...")
                                    verificacao = str(pagina2.cell(row=linha,column=3).value)
                                    pagina2.delete_rows(linha,1)
                                    verificacao = str(pagina2.cell(row=linha,column=3).value)
                                else:
                                ...
                                if despesa_certificada_teste == despesa_certificada:
                                    ...
                                    if despesa_certificada == "pesquisar no sigef":
                                        ...
                                        try:
                                            ...
                                            book_backup.save("Backup.xlsx")
                                            pagina2.delete_rows(linha,1)
                                            pagina2.append([ug,gestao,processo_formatado,credor_final,cpf_final,valor_final,banco,agencia,conta,nota_de_empenho,despesa_certificada,ainda_nao_foi_feito,ainda_nao_foi_feito,ainda_nao_foi_feito,data,operacao,data_formatada,agora,value_numero_cortado])
                            ...
                            while ja_foi_liquidado == False:
                                ...
                                with liquidar_despesa_certificada.expect_popup() as popup_info:
                                    ...
                                    if valor_liquido == valor:
                                        ...
                                        if liquidacao == "ERRO":
                                            ...
                                            try:
                                                    ...
                                                    pagina3.append([ug,gestao,processo,nome,cpf,valor_que_vai_pra_planilha,banco, agencia,conta,nota_de_empenho,despesa_certificada,liquidacao,ainda_nao_foi_feito,ainda_nao_foi_feito,data,operacao,data_do_pagamento,agora,value_numero_cortado])
                                                    book.save(planilha)
                                                    book_backup.save("Backup.xlsx")
                                            except:           
                                    ...
                                    try:
                                        ...
                                        book_backup.save("Backup.xlsx")
                                        pagina3.append([ug,gestao,processo,nome,cpf,valor_que_vai_pra_planilha,banco,agencia,conta,nota_de_empenho,despesa_certificada,liquidacao,ainda_nao_foi_feito,ainda_nao_foi_feito,data,operacao,data_do_pagamento,agora,value_numero_cortado])
                                        verificacao = str(pagina3.cell(row=linha,column=3).value)
                                        numero_de_linhas_apagadas = 0
